	...
	<div class="titulo-portfolio" id="portfolio5">
		/<?php
	...
	<article>
		...
		<div class="gamma-container gamma-loading" id="gamma-container">
			...
			<ul class="gamma-gallery">
				<?php
					$diretorio = scandir("images/portfolio5/large");
						...
						echo "
							<li>
								...
								<div data-alt='img$i' data-description='<h3></h3>' data-max-width='1800' data-max-height='1350'>
									<div data-src='images/portfolio5/xxxlarge/$i.jpg' data-min-width='1300'></div>
									<div data-src='images/portfolio5/xxlarge/$i.jpg' data-min-width='1000'></div>
									<div data-src='images/portfolio5/xlarge/$i.jpg' data-min-width='700'></div>
									<div data-src='images/portfolio5/large/$i.jpg' data-min-width='300'></div>
									<div data-src='images/portfolio5/medium/$i.jpg' data-min-width='200'></div>
									<div data-src='images/portfolio5/small/$i.jpg' data-min-width='140'></div>
									<div data-src='images/portfolio5/xsmall/$i.jpg'></div>
									<noscript>
										<img src='images/portfolio5/xsmall/$i.jpg' alt='img$i'/>
									</noscript>
								</div>
							</li>			
						";
		...
		<script>
			...
			$("#portfolio3,#portfolio4,#portfolio1,#portfolio2").hover(
			  function () {
